...
use futures::prelude::*;
use substrate_parcel_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi, WASM_BINARY};
...
native_executor_instance!(
	pub Executor,
	substrate_parcel_runtime::api::dispatch,
	substrate_parcel_runtime::native_version
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			substrate_parcel_runtime::opaque::Block, substrate_parcel_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (block_import, link_half) =
					grandpa::block_import::<_, _, _, substrate_parcel_runtime::RuntimeApi, _, _>(
